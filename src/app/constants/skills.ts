...
export const SkillInfo: SkillDTO[] = [
  ...
  { title: 'Angular, React ', progressInPercent: '90', skillLevel: 'Advanced' },
  {
    title: 'Flutter,Native Android Development',
  ...
  {
    title: 'MySQL,MongoDB,PostgresSQL',
    progressInPercent: '80',
    skillLevel: 'Advanced',
  },
  {
    title: 'Payment Integration(Chapa)',
